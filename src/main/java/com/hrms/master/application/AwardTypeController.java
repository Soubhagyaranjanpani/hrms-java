...
public class AwardTypeController {
    ...
    private final CreateAwardTypeUseCase createUseCase;
    private final UpdateAwardTypeUseCase updateUseCase;
    private final ChangeAwardTypeStatusUseCase changeStatusUseCase;
    private final GetAwardTypeUseCase getUseCase;

    @PostMapping("/create")
    public ResponseEntity<ApiResponse<DefaultResponse>> create(
            @RequestBody AwardTypeCreateReq request) {
        return ResponseEntity.ok(createUseCase.execute(request));
    }

    @PutMapping("/update")
    public ResponseEntity<ApiResponse<DefaultResponse>> update(
            @RequestBody AwardTypeUpdateReq request) {
    ...
    @GetMapping("/list")
    public ResponseEntity<ApiResponse<List<AwardTypeResponse>>> getAll(
