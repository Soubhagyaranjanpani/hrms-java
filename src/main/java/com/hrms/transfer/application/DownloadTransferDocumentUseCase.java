// File: com/hrms/transfer/application/DownloadTransferDocumentUseCase.java
...
public class DownloadTransferDocumentUseCase {
    ...
    public DocumentFile execute(Long id) throws Exception {
        ...
        if (r.getDocumentPath() == null || r.getDocumentPath().isBlank()) {
            throw new RuntimeException("No document available for this transfer record");
        }
