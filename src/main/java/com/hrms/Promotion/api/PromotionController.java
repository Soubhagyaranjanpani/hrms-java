...
////    private final TogglePromotionStatusUseCase          toggleStatusUseCase;
...
//
//    // ✅ NEW: Use case for explicit status set (active/inactive)
...
//    }
//
//    // ── ✅ NEW: GET /api/promotions/data?flag=0&id=... ──
//    //    flag=0 → returns all records (list)
//    //    flag=1 → returns a single record by ID (requires id parameter)
//    @GetMapping("/data")
...
public class PromotionController {
    ...
    private final CreatePromotionUseCase                createUseCase;
    private final UpdatePromotionRecordUseCase          updateUseCase;
    // ❌ TogglePromotionStatusUseCase REMOVED (as requested)
    private final UploadPromotionDocumentUseCase        uploadDocumentUseCase;
    private final DownloadPromotionDocumentUseCase      downloadDocumentUseCase;
    private final PromotionRepository                   promoRepo;
    private final PromotionMapper                       mapper;

    // ✅ UNCOMMENTED: Use case for explicit status set (active/inactive)
    private final SetPromotionStatusUseCase             setStatusUseCase;
